...
const ChatUser = () => {
   ...
   useEffect(() => {
      ...
      try {
         $.ajax({
            method: 'GET',
            url: `https://monkigo.com/dump/iata/search?token=${localStorage.getItem('token')}&s=${iata}`,
            success: function (result) {
   ...
   useEffect(() => {
         ...
         <div class="chat-messenger__content content-left content-admin">
            ...
            <div class="chat-messenger__content__action">
               <div class="btn-group">
                  ...
                  <button id="btnVillageLink" class="btn btn-outline btn-outline-sm btn-outline-primary" style="margin: 0; padding: 10px 0; min-width: 138px">Youth Accommodation</button>
      ...
      ////////////////////////////////////////////////////HOTELS /////////////////////////////////////
      $(document).on('click', '#btnHotelsLink', () => {
         $(chatBody).append(`
            <div class="chat-messenger__content content-right content-user">
               <div class="chat-messenger__content__container">
                  ...
                  <div class="chat-messenger__holder">
                     <div class="chat-messenger__text">Hotels.</div>
                     <div class="chat-messenger__statusbar">
                     <span class="chat-messenger__date">${new Intl.DateTimeFormat('en-US', { hour: 'numeric', minute: 'numeric' }).format(new Date(Date.now()))}</span>
                     <span class="chat-messenger__status readed"></span>
                 </div> 
                  </div>
               </div>
            </div>
         ...
         $(chatBody).append(`
            <div class="chat-messenger__content content-left content-admin">
               <div class="chat-messenger__content__container">
                  ...
                  <div class="chat-messenger__holder">
                     <div class="chat-messenger__text">Click button to search for hotels.</div>
                     <div class="chat-messenger__statusbar">
                     <span class="chat-messenger__date">${new Intl.DateTimeFormat('en-US', { hour: 'numeric', minute: 'numeric' }).format(new Date(Date.now()))}</span>
                     <span class="chat-messenger__status"></span>
                 </div> 
               ...
               <div class="chat-messenger__content__action">
                  <button id="btnHotelsSearch" class="btn btn-fluid btn-primary">Search</button>
               </div>
            </div>
         `);
         ChatBodyScrollTo();
      ...
      //////////////////////////////////////////////////////FLIGHTS///////////////////////////////////////////////
      $(document).on('click', '#btnFlightsLink', () => {
         $(chatBody).append(`
            <div class="chat-messenger__content content-right content-user">
               <div class="chat-messenger__content__container">
                  <div class="chat-messenger__avatar">
                  ...
                  <div class="chat-messenger__holder">
                     <div class="chat-messenger__text">Flights.</div>
                     <div class="chat-messenger__statusbar">
                     <span class="chat-messenger__date">${new Intl.DateTimeFormat('en-US', { hour: 'numeric', minute: 'numeric' }).format(new Date(Date.now()))}</span>
                     <span class="chat-messenger__status readed"></span>
                 </div> 
         ...
         $(chatBody).append(`
            <div class="chat-messenger__content content-left content-admin">
               <div class="chat-messenger__content__container">
                  ...
                  <div class="chat-messenger__holder">
                     <div class="chat-messenger__text">Click button to search for flights.</div>
                     <div class="chat-messenger__statusbar">
                     <span class="chat-messenger__date">${new Intl.DateTimeFormat('en-US', { hour: 'numeric', minute: 'numeric' }).format(new Date(Date.now()))}</span>
                     <span class="chat-messenger__status"></span>
                 </div> 
               ...
               <div class="chat-messenger__content__action">
                  <button id="btnFlightsSearch" class="btn btn-fluid btn-primary">Search</button>
               </div>
            </div>
         `);
      ...
      ///////////////////////////////////////////////////VILLAGE/////////////////////////////////////////////////////
      $(document).on('click', '#btnVillageLink', () => {
         $(chatBody).append(`
            <div class="chat-messenger__content content-right content-user">
               <div class="chat-messenger__content__container">
                  <div class="chat-messenger__avatar">
                  ...
                  <div class="chat-messenger__holder">
                     <div class="chat-messenger__text">Youth Accommodation.</div>
                     <div class="chat-messenger__statusbar">
                     <span class="chat-messenger__date">${new Intl.DateTimeFormat('en-US', { hour: 'numeric', minute: 'numeric' }).format(new Date(Date.now()))}</span>
                     <span class="chat-messenger__status readed"></span>
                 </div> 
         ...
         //                      class="img-fluid border-radius-full" alt="avatar">
         //             </div>
         //             <div class="gallery-preview" data-modal="modal-gallery" id="budget_hotel_gallery_wrapper">
         //                <div class="gallery-preview__item">
         //                      <img src="https://cdn.monkigo.com/budget-hotel/1.jpg"
         //                         class="w-100 h-100 object-fit-cover" alt="gallery-img">
         //                </div>
         //                <div class="gallery-preview__item">
         //                      <img src="https://cdn.monkigo.com/budget-hotel/2.jpg"
         //                         class="w-100 h-100 object-fit-cover" alt="gallery-img">
         //                </div>
         //                <div class="gallery-preview__item">
         //                      <img src="https://cdn.monkigo.com/budget-hotel/3.jpg"
         //                         class="w-100 h-100 object-fit-cover" alt="gallery-img">
         //                      <span class="preview-count">+4</span>
         //                </div>
         //             </div>
         //          </div>
         //    </div>
         ...
         //       </div>
         //       <div class="chat-messenger__holder">          
         //          <div class="chat-messenger__text">If you liked it, click the button below and enter
         //                details to reserve.
         //          </div>
         //          <span class="chat-messenger__price">Price: €29</span>
         //          <span class="chat-messenger__date">${new Intl.DateTimeFormat('en-US', { hour: 'numeric', minute: 'numeric' }).format(new Date(Date.now()))}</span>
         //       </div>
         //       </div>
         //       <div class="chat-messenger__content__action">
         //          <button class="btn btn-fluid btn-primary" id="reserve_budget_hotel_btn">Reserve</button>
         //       </div>
         //    </div>
         // `)
         ...
         $(chatBody).append(`
            ...
            To apply for the special discounted Youth Accommodation rates, you should be:<br/>
            ·        18 to 35 years old on 1 October 2023.<br/>
            ·        A student currently attending a recognized university or;<br/>
            ·        A Young Professional currently employed in a space-related field;<br/>
            ·        A primary or secondary teacher, or professor.<br/><br/>
             
            The “Youth Accommodation” located just 10 minutes’ drive from the Congress Venue and next to the city transport hub, welcomes the visitors with its own residential zone, nearby shops, restaurants, and much more. The “Youth Accommodation” offers 2 beds in each room equipped with Wi-Fi and all necessary amenities.
            The initiative enables more than 1,000 applicants to get the safe accommodation for special price – <b>just 29 euro per night</b>. The offer is available on a first come first serve basis.
            </div>
         `);
         ...
         $(chatBody).append(`
            <div class="chat-messenger__content content-left content-admin">
               <div class="chat-messenger__content__container">
                  ...
                  <div class="chat-messenger__holder">
                     <div class="chat-messenger__text">
                     Please enter this details in the chat<br/>
                     with the concierge below this message:<br/>
                     Name, Last name, Id Number, IAC2023 Registration Number<br/><br/>
                     Send a scan of following documents to<br/>
                     <a href="mailto:youth-accommodation@iac2023.org" class="link" style="font-size: 14px; font-weight: 500;">youth-accommodation@iac2023.org</a> –<br/>passport, student card, proof of current education/employment.</div>
                     <div class="chat-messenger__statusbar">
                     <span class="chat-messenger__date">${new Intl.DateTimeFormat('en-US', { hour: 'numeric', minute: 'numeric' }).format(new Date(Date.now()))}</span>
                     <span class="chat-messenger__status"></span>
                 </div> 
      ...
      $(document).on('click', '#btnHotelsSearch', () => {
         window.location.href = 'https://iac.monkigo.com';
      });

      ///////////////////////////////////////////////////VILLAGE/////////////////////////////////////////////////////
      $(document).on('click', '#btnSocialTour', () => {
         var msgID = uid();
         ...
         $('#chatBody').append(`
            <div class="chat-messenger__content content-right content-user" id='${msgID}'>
               <div class="chat-messenger__content__container">
                  ...
                  <div class="chat-messenger__holder">
                     <div class="chat-messenger__text">Social Tour.</div>
                     <div class="chat-messenger__statusbar">
                     <span class="chat-messenger__date">${new Intl.DateTimeFormat('en-US', { hour: 'numeric', minute: 'numeric' }).format(new Date(Date.now()))}</span>
         ...
         $('#chatBody').append(`
            <div class="chat-messenger__content content-left content-admin">
               <div class="chat-messenger__content__container">
                  ...
                  <div class="chat-messenger__holder">
                     <div class="chat-messenger__text">Click button to search for social tours.</div>
                     <div class="chat-messenger__statusbar">
                     <span class="chat-messenger__date">${new Intl.DateTimeFormat('en-US', { hour: 'numeric', minute: 'numeric' }).format(new Date(Date.now()))}</span>
                     <span class="chat-messenger__status"></span>
                  </div> 
               ...
               <div class="chat-messenger__content__action">
                  <a href="/social-tours"><button id="btnTransferSearch" class="btn btn-fluid btn-primary">Search</button></a>
               </div>
            </div>
         `);
         ...
         $('#chatBody').append(`
            <div class="chat-messenger__content content-right content-user" id='${msgID}'>
               <div class="chat-messenger__content__container">
                  ...
                  <div class="chat-messenger__holder">
                     <div class="chat-messenger__text">Transfer.</div>
                     <div class="chat-messenger__statusbar">
                     <span class="chat-messenger__date">${new Intl.DateTimeFormat('en-US', { hour: 'numeric', minute: 'numeric' }).format(new Date(Date.now()))}</span>
                     <span class="chat-messenger__status sending"></span>
               </div>    
         ...
         $('#chatBody').append(`
            <div class="chat-messenger__content content-left content-admin">
               <div class="chat-messenger__content__container">
                  ...
                  <div class="chat-messenger__holder">
                     <div class="chat-messenger__text">Click button to search for transfer.</div>
                     <div class="chat-messenger__statusbar">
                     <span class="chat-messenger__date">${new Intl.DateTimeFormat('en-US', { hour: 'numeric', minute: 'numeric' }).format(new Date(Date.now()))}</span>
                     <span class="chat-messenger__status"></span>
                  </div> 
               ...
               <div class="chat-messenger__content__action">
                  <button id="btnTransferSearch" class="btn btn-fluid btn-primary">Search</button>
               </div>
            </div>
         `);
   ...
   function CheckMessageStatus(msgID) {
      if (socketState.current.readyState !== null) {
         if (socketState.current.readyState === 1) {
            var message = {
               msgID: msgID,
   ...
   function GetUserChatsMessages() {
      ...
      $.ajax({
         method: 'GET',
         url: 'https://monkigo.com/app/v1/concierge/chat/user/messages?token=' + localStorage.getItem('token'),
         dataType: 'json',
         success: (content) => {
   ...
   useEffect(() => {
      setInterval(() => {
         if (socketState.current !== null) {
            if (socketState.current.readyState === 1) {
               socketState.current.send(new TextEncoder().encode(JSON.stringify({ target: 'ping' })));
            }
         }
      }, 10000);
   }, []);
   ...
   useEffect(() => {
      if (btnSendMessage !== false) {
         var msgID = uid();
         const messageTemp = userMessage.replace(/(\r\n|\r|\n)/g, '<br/>');
         var appendText = `
         <div class="chat-messenger__content content-right content-user" id='${msgID}'>
            <div class="chat-messenger__content__container">
               <div class="chat-messenger__avatar">
               ...
               <div class="chat-messenger__holder">
                  <div class="chat-messenger__text">${messageTemp}</div>
                  <div class="chat-messenger__statusbar">
                  <span class="chat-messenger__date">${new Intl.DateTimeFormat('en-US', { hour: 'numeric', minute: 'numeric' }).format(new Date(Date.now()))}</span>
                  <span class="chat-messenger__status sending"></span>
              </div>    
         ...
         if ((value[1] === null && flightDirection === 'One way') || (value[1] !== null && flightDirection === 'Return')) {
            if (socketState !== null) {
               ...
               var messageBody = `<div class="info-list">
                        <span class="info-list__title">Flight search</span>
                        <span class="info-list__item">${flightDirection} / ${flightClasses} class</span>
                        <span class="info-list__item"> ${GuestCountCalc()} </span>
                        <span class="info-list__item">From: ${$('.from-input').val()}</span>
                        <span class="info-list__item">To: Baku (GYD)</span>
                        <span class="info-list__item">Departure: ${new Intl.DateTimeFormat('en-US', { year: 'numeric', month: 'long', day: 'numeric' }).format(new Date(value[0]))}</span>
                        <span class="info-list__item">Return: ${value[1] !== null ? new Intl.DateTimeFormat('en-US', { year: 'numeric', month: 'long', day: 'numeric' }).format(new Date(value[1])) : 'No Return'}</span>
                  </div>`;
               var appendText = `
                  <div class="chat-messenger__content content-right content-user" id='${msgID}'>
                     <div class="chat-messenger__content__container">
            ...
            if (socketState.current.readyState === 1) {
               ...
               var msgForSever = `
                  <div class="info-list">
                     ...
                     <span class="info-list__item">Phone: ${primaryContactDetails.phone}</span>
                     <span class="info-list__item">E-mail: ${primaryContactDetails.email}</span>
                  </div>
               `;
               appendText = `
                  <div class="chat-messenger__content content-right content-user" id='${msgID}'>
               ...
               for (var i = 0; i < guest.length; i++) {
                  ...
                  if (i === 0) {
                     msgForSever = `
                        <div class="info-list">
                           <span class="info-list__title">Primary passenger details</span>
                           <span class="info-list__item">Given name: ${guest[i].name}</span>
                           <span class="info-list__item">Surname: ${guest[i].surname}</span>
                           <span class="info-list__item">Gender: ${guest[i].gender}</span>
                           <span class="info-list__item">Date of birth: ${guest[i].birthDay}</span>
                           <span class="info-list__item">Passport or ID number: ${guest[i].passport}</span>
                           <span class="info-list__item">Expiration date: ${guest[i].expDate}</span>
                           <span class="info-list__item">Country of issue: ${guest[i].country}</span>
                        </div>
                     `;
                  }
                  else {
                     msgForSever = `
                        <div class="info-list">
                           <span class="info-list__title">Passenger ${i + 1} details</span>
                           <span class="info-list__item">Given name: ${guest[i].name}</span>
                           <span class="info-list__item">Surname: ${guest[i].surname}</span>
                           <span class="info-list__item">Gender: ${guest[i].gender}</span>
                           <span class="info-list__item">Date of birth: ${guest[i].birthDay}</span>
